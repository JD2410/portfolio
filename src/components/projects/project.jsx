...
const project = (prop) => {
    return (
        <>
        <article className="grid grid-cols-1 sm:grid-cols-12 gap-8 mb-6 items-center max-w-6xl drop-shadow-lg bg-white p-6 text-gray-700 rounded-xl">
            ...
            <div className="sm:col-span-7 flex flex-col gap-2 content-between" >
                ...
                <ul className="flex flex-wrap gap-2 overflow-hidden h-[28px] whitespace-nowrap">
                ...
                <p className="leading-[2.1rem] text-gray-700 line-clamp-5" >{prop.project.description}</p>
                <p className="font-bold whitespace-nowrap overflow-hidden text-ellipsis"><span className="text-[#0972D3]">Roles:</span> {prop.project.roles.map((ele,index) => (
                            ele + ", "
                        ))}</p>
